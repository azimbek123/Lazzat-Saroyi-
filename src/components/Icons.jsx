...
export function IconFlame({ className = "w-4 h-4" }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 20 20">
      <path fillRule="evenodd" d="M12.395 2.553a1 1 0 00-1.45-.385c-.345.23-.614.558-.822.88-.316.492-.533 1.05-.724 1.625-.373 1.124-.652 2.37-.893 3.635-.468-.82-1.076-1.57-1.745-2.203a1 1 0 00-1.488.163c-.878 1.154-1.328 2.456-1.42 3.69-.115 1.554.436 3.193 1.628 4.385C7.03 15.69 8.92 16.5 11 16.5c2.316 0 4.298-.95 5.485-2.483 1.173-1.517 1.486-3.415.823-5.228-.62-1.693-1.954-3.155-3.49-4.385a15.8 15.8 0 00-1.423-1.851zM11 14.5c-1.417 0-2.613-.544-3.37-1.3A3.75 3.75 0 016.5 10.5c.063-.787.35-1.637.892-2.476.323.364.673.743 1.047 1.134a1 1 0 001.666-.372c.32-1.12.637-2.277.986-3.324.78.71 1.492 1.547 1.942 2.493.42 1.147.228 2.33-.518 3.32-.614.815-1.54 1.225-2.515 1.225z" clipRule="evenodd" />
    </svg>
  );
}
...
export function IconSliders({ className = "w-5 h-5" }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
